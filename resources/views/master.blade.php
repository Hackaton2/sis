...
<head>
  ...
  <link rel="stylesheet" href="{{ URL::asset('plugins/datatables/dataTables.bootstrap.css') }}">
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/horario.css') }}">
...
<!-- datetimepicker -->
    <script src="{{ URL::asset('js/horario/moment-with-locales.js') }}"></script>
    <script src="{{ URL::asset('js/horario/bootstrap-datetimepicker.js') }}"></script>
    <!-- validate -->
    <script src="{{ URL::asset('js/horario/jquery.validate.min.js') }}"></script>
    <script src="{{ URL::asset('js/horario/additional-methods.min.js') }}"></script>
    <!-- script -->
    <script src="{{ URL::asset('js/horario/script.js') }}"></script>
...
<script type="text/javascript">
  function registrar(title,content){
            ...
            var content = content;
            var footer = 
            '<button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button><button type="submit" onclick="enviar_formulario();" class="btn btn-primary">Aceptar</button>';
